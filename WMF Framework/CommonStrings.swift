...
public class CommonStrings: NSObject {
    ...
    @objc public static let customizeExploreFeedTitle = WMFLocalizedString("explore-feed-preferences-customize-explore-feed-action-title", value: "Customize...", comment: "Title for action that allows users to go to the Explore feed settings screen")
